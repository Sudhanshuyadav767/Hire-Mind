...
// SSR disable for CircularProgressbar
    ...
    <>
      ...
      <div className="w-full flex flex-col md:flex-row gap-5 lg:gap-6 border rounded-xl shadow-sm bg-[#F3F0FF] p-4 sm:p-5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <h2 className="text-base sm:text-lg font-bold mt-2 sm:mt-4 text-center md:text-left">
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-end gap-2 shrink-0">
                ...
                <Link href="/Job-Matching/View-Details">
