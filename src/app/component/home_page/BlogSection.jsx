...
const BlogSection = () => {
  return (
    <div className="home-section home-blogs w-full max-w-7xl mx-auto px-4 py-12 bg-white select-none">
      ...
      {/* Grid Layout: Mobile pe horizontal scroll slider, Tablet pe 2, Desktop pe 4 columns */}
      <div className="home-swiper flex flex-row overflow-x-auto no-scrollbar snap-x snap-mandatory md:grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        {blogs.map((blog, index) => (
          <div 
            key={index} 
            className="border border-gray-200 rounded-2xl overflow-hidden bg-white shadow-2xs hover:shadow-md transition-all duration-300 flex flex-col shrink-0 w-[240px] md:w-auto snap-start"
          >
            ...
            <div className="p-4 flex flex-col flex-1 justify-between gap-3">
              ...
              <div className="flex items-center gap-4 text-xs text-gray-400 text-left">
                <span className="flex items-center gap-1">
                   <CalendarFold size={14} /> {blog.date}
                </span>
                <span className="flex items-center gap-1">
              ...
              <div className="text-left">
                <h3 className="font-poppins font-medium text-black text-sm leading-snug line-clamp-2 hover:text-blue-600 cursor-pointer transition-colors">
                  {blog.title}
                </h3>
                <p className="text-[11px] text-gray-400 mt-1.5 line-clamp-3 leading-relaxed">
                  {blog.description}
                </p>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex flex-col text-left">
                    <span className="text-[10px] font-semibold text-gray-900 leading-tight">{blog.author}</span>
                    <span className="text-[9px] text-gray-400 font-medium">{blog.role}</span>
                  </div>
                </div>
